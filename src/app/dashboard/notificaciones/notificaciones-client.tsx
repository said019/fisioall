  ...
  return (
    <div className="flex flex-col gap-5 p-4 md:p-6 bg-[#f0f4f7] min-h-full">
      ...
      <Tabs defaultValue="alertas" className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 max-w-lg bg-[#f0f4f7] border border-[#c8dce8]">
          ...
          <TabsTrigger value="whatsapp" className="flex gap-2 data-[state=active]:bg-white data-[state=active]:text-[#1e2d3a]">
