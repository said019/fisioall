    ...
    <div className="space-y-6">
        ...
        <Card className="border-[#c8dce8] shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs font-semibold text-[#1e2d3a]/50 uppercase tracking-wide">NPS Score</p>
                <div className="flex items-baseline gap-2 mt-1">
                  <p className={`text-3xl font-bold ${npsScore >= 50 ? "text-emerald-600" : npsScore >= 0 ? "text-amber-600" : "text-red-500"}`}>
                    {npsScore > 0 ? "+" : ""}{npsScore}
                  </p>
                </div>
                <p className="text-[11px] text-[#1e2d3a]/40 mt-0.5">
      ...
      <Tabs defaultValue="respuestas" className="space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <TabsList className="bg-[#e4ecf2] border border-[#c8dce8]">
            <TabsTrigger value="respuestas" className="cursor-pointer data-[state=active]:bg-[#4a7fa5] data-[state=active]:text-white">
              <CheckCircle2 className="h-3.5 w-3.5 mr-1.5" /> Respondidas
              <Badge className="ml-1.5 h-5 px-1.5 text-[10px] bg-[#4a7fa5]/20 text-[#4a7fa5] border-none">
                {respondidas.length}
              </Badge>
            </TabsTrigger>
            <TabsTrigger value="pendientes" className="cursor-pointer data-[state=active]:bg-[#4a7fa5] data-[state=active]:text-white">
            ...
            respondidas
              ...
              .map((enc) => {
                ...
                return (
                  <Card
                    key={enc.id}
                    className="border-[#c8dce8] hover:shadow-md transition-all duration-200 cursor-pointer"
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <Avatar className="h-6 w-6 border border-[#a8cfe0]">
                              <AvatarFallback className="bg-[#4a7fa5]/15 text-[#4a7fa5] text-[10px] font-bold">
                          ...
                          {enc.comentarios && (
                            <p className="text-sm text-[#1e2d3a]/60 leading-relaxed line-clamp-2 mb-2">
                        ...
                        <div className="text-right shrink-0">
                          <p className="text-[10px] text-[#1e2d3a]/30">
                            {enc.respondidaAt && formatFechaHora(enc.respondidaAt)}
                          </p>
                          <ChevronRight className="h-4 w-4 text-[#1e2d3a]/20 mt-2 ml-auto" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <DialogContent className="max-w-md">
          {modalDetalle && (() => {
            ...
            return (
              <>
                <DialogHeader>
                  <DialogTitle className="text-[#1e2d3a]">Detalle de Encuesta</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  ...
                  {modalDetalle.comentarios && (
                    <div>
                      <p className="text-xs font-semibold text-[#1e2d3a]/50 mb-1.5">Comentarios del Paciente</p>
                      <div className="bg-[#e4ecf2]/50 rounded-xl p-3">
                        <p className="text-sm text-[#1e2d3a]/70 leading-relaxed italic">
